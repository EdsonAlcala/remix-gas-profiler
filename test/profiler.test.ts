...
describe('Profiler tests', () => {
    ...
    it('generate the gas profiler report', async () => {
        ...
        // PROVIDER not being passed yet, 
        //CONTRACT_ADDRESS);
        const bytecode = '' // await web3.eth.getCode(contractAddress);
