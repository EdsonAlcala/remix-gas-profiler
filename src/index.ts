...
export class Profiler {
    ...
    private readonly client: PluginApi<Readonly<IRemixApi>> & PluginClient<Api, Readonly<IRemixApi>>
    ...
    public async init() {
        ...
        this.client.on('udapp', 'newTransaction', async (tx: RemixTx) => { // TODO: RemixTx type wrong
